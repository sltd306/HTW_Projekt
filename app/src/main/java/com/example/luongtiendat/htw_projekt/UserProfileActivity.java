    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")){
                    Picasso.with(UserProfileActivity.this).load(image).placeholder(R.drawable.defaut_avatar).into(mDisplayImage);
                }
        ...
        mUpdateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent profileEditIntent = new Intent(UserProfileActivity.this,UserProfileEditActivity.class);
                                        ...
                                        mUserDatabase.updateChildren(update_hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful()){
                                                    ...
                                                    Toast.makeText(UserProfileActivity.this,"Success Uploading",Toast.LENGTH_LONG).show();
                                                }
                                            }
                                        });
                                    }
