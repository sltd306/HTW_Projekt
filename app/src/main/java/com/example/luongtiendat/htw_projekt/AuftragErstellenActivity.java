...
public class AuftragErstellenActivity extends AppCompatActivity {
    ...
    private void auftragErstellen(String titel, String stellenBeschreibung, String arbeitZeit, String arbeitOrt, String vergutung, String beginn) {
        ...
        final @SuppressWarnings("VisibleForTests")String auftrag_id = "auftrag_"+random();
        ...
        mAuftragDatabase.child(auftrag_id).setValue(auftragMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
        ...
        /*
        mAuftragDatabase.child(auftrag_id).child("titel").setValue(titel).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "Titel Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "Titel Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mAuftragDatabase.child(auftrag_id).child("stellen_beschreibung").setValue(stellenBeschreibung).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "Stellen Beschreibung Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "Stellen Beschreibung Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mAuftragDatabase.child(auftrag_id).child("arbeit_zeit").setValue(arbeitZeit).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "Arbeit Zeit Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "Arbeit Zeit Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mAuftragDatabase.child(auftrag_id).child("arbeit_ort").setValue(arbeitOrt).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "Arbeit Ort Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "Arbeit Ort Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mAuftragDatabase.child(auftrag_id).child("vergutung").setValue(vergutung).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "Vergütung Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "Vergütung Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mAuftragDatabase.child(auftrag_id).child("beginn").setValue(beginn).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "Begin Tätigkeit Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "Begin Tätigkeit Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mAuftragDatabase.child(auftrag_id).child("userID").setValue(current_uid).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AuftragErstellenActivity.this, "UserId Update Successfully! ", Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(AuftragErstellenActivity.this, "UserId  Update fail!! ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        */
